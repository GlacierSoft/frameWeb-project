 ...
 */ 
 function EmailAutoComplete(options) {
	...
	this.config = {
		...
		mailArr        : ["@qq.com","@sina.com","@163.com","@sohu.com","@126.com","@hotmail.com","@yahoo.com","@yahoo.com.cn","@live.com","@gmail.com"], //邮箱数组
		...
		if(curIndex > -1){
			...
			if(_cache.onlyFlag) {
				...
				$('.auto-tip',cfg.parentNode).css({'position':'absolute','top':cfg.height,'width':cfg.width - 2 + 'px','left':0,
					'border':'1px solid #ccc','z-index':10000,'background-color':'white', 'margin-left':'18px' });
			}
